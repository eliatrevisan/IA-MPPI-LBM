...
class SeqToSeqModel2():#tfk.Model
	...
	def __init__(self, args):
		...
		self.encoder_lstm = tfkl.LSTM(self.latent_dim, return_state=True,stateful=args.stateful)

		self.encoder_outputs, self.state_h, self.state_c = self.encoder_lstm(self.encoder_inputs)
		...
		self.decoder_lstm = tfkl.LSTM(self.latent_dim, return_sequences=True, return_state=True)
		...
		# This model is used only for inference
