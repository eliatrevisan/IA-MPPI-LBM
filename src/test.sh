...
python3 test_VGDNN.py --exp_num 1 --model_name VGDNN --num_test_sequences 10 --scenario simulation/roboat --record true --n_samples 12 --unit_testing false --freeze_other_agents false;
