...
python3 test_VGDNN.py --exp_num 18 --model_name VGDNN --constant_velocity true --num_test_sequences 12 --scenario simulation/roboat --record false --n_samples 1 --unit_testing false --freeze_other_agents false;
