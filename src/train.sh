...
python3 train_roboat.py --exp_num 316 --model_name VGDNN --total_training_steps 20000 --n_mixtures 1 --output_pred_state_dim 4 --scenario herengracht --gpu false --prev_horizon 8 --prediction_horizon 12 --dt 0.8 --truncated_backprop_length 8 --others_info relative --pedestrian_vector_dim 4 --batch_size 16 --diversity_update false --submap_span_real 14 --relative_covariance 10.0;
