...
class DataHandlerLSTM():
	...
	def load_map(self,**kwargs):
		...
		#if not os.path.isfile(self.data_path+self.args.scenario + '/map.npy'): # SHOULD CHANGE BACK TO .npy
		#	print("Creating map from png ...")
		#	sup.create_map_from_png(data_path=self.args.data_path+self.args.scenario,**kwargs)

		###### This is a little hack becase the sup.create_map_from_png() does not seem to work (runs forever)
		# TODO: ask bruno about it, but this should work
