...
submap_span_real = 10 # Coordinates
...
# Create Datahandler class for the specified scenario
if args.scenario == "herengracht":
...
elif args.scenario == "bloemgracht":
	data_prep = dhlstm.DataHandlerLSTM(args)
	map_args = {"file_name": 'map.png',
				"resolution": 0.22,
...
elif args.scenario == "open_crossing":
	data_prep = dhlstm.DataHandlerLSTM(args)
	map_args = {"file_name": 'map.png',
				"resolution": 0.6,
...
elif args.scenario == "prinsengracht":
	data_prep = dhlstm.DataHandlerLSTM(args)
	map_args = {"file_name": 'map.png',
				"resolution": 0.091,
